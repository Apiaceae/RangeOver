...
var options = {
  zoom: 3,
  center: new google.maps.LatLng(30.59, 114.31), mapTypeId: google.maps.MapTypeId.ROADMAP
};
...
var content = '<strong>' + results[0].formatted_address + '</strong><br />'; content += 'Lat: ' + results[0].geometry.location.lat() + '<br />';
